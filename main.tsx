...
`;
  ...
  <html lang={l}>
    ...
    // 🔥 FIX: Always show the selected season (Don't toggle back to hidden)
...
// 🔥 AUTO-OPEN First Season on Page Load
document.addEventListener('DOMContentLoaded', () => {
...
app.get(ADMIN_ROUTE + "/dashboard", adminGuard, async (c) => { 
    ...
    // 🔥 FIXED: Draft Edit Support
const editId = c.req.query("edit"); 
const isDraft = c.req.query("type") === "draft"; // New: Check if editing draft
let editMovie = null;
